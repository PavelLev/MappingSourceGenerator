...
public static class ManualMappingTestData
{
    public static IEnumerable<object[]> Data 
        => new[]
        {
            new object[]
            {
                "Manual.NestedPropertyWithManualMappingTest",
                """
                #nullable enable
                using System;
            ...
            new object[]
            {
                "Manual.NestedArrayWithManualItemMappingTest",
                """
                #nullable enable
                using System;
                using System.Collections.Generic;
            ...
            new object[]
            {
                "Manual.NestedListWithManualItemMappingTest",
                """
                #nullable enable
                using System;
                using System.Collections.Generic;
            ...
            new object[]
            {
                "Manual.NestedCollectionWithManualMappingTest",
                """
                #nullable enable
                using System;
                using System.Collections.Generic;
            ...
            new object[]
            {
                "Manual.NestedArrayWithManualMappingTest",
                """
                #nullable enable
                using System;
                using System.Collections.Generic;
            ...
            new object[]
            {
                "Manual.NestedCollectionWithEnumPropertyTest",
                """
                #nullable enable
                using System;
                using System.Collections.Generic;
            ...
            new object[]
            {
                "Manual.NullableEnumPropertyWithManualNullableMappingTest",
                """
                #nullable enable
                using System;
                using System.Collections.Generic;
                ...
                public static partial class ManualMappingTestsMapper
                {
                    ...
                    public static ManualMappingTests.PhoneType2? MapNullable(
                        this ManualMappingTests.PhoneType1? phoneType)
                        => phoneType switch
                        {
                            null => null,
                            ManualMappingTests.PhoneType1.Android1 => ManualMappingTests.PhoneType2.Android2,
                            _ => throw new InvalidOperationException($"Unable to map phone type {phoneType}")
                        };
                }
                """,
                """
                ...
                partial class ManualMappingTestsMapper
                {
                    public static partial MappingSourceGenerator.UnitTests.ManualMappingTests.PersonWithOptionalPhoneType2 MapNullable(
                        this MappingSourceGenerator.UnitTests.ManualMappingTests.PersonWithOptionalPhoneType1 personWithOptionalPhoneType1)
                        => new(
                            personWithOptionalPhoneType1.Name,
                            personWithOptionalPhoneType1.PhoneType.MapNullable());
                }
                """
            },
            new object[]
            {
                "Manual.NullableEnumPropertyWithManualNonNullableMappingTest",
                """
                #nullable enable
                using System;
                using System.Collections.Generic;
                ...
                public static partial class ManualMappingTestsMapper
                {
                    ...
                    public static ManualMappingTests.PhoneType2 MapNonNullable(
                        this ManualMappingTests.PhoneType1 phoneType)
                        => phoneType switch
                        {
                            ManualMappingTests.PhoneType1.Android1 => ManualMappingTests.PhoneType2.Android2,
                ...
                partial class ManualMappingTestsMapper
                {
                    public static partial MappingSourceGenerator.UnitTests.ManualMappingTests.PersonWithOptionalPhoneType2 MapNonNullable(
                        this MappingSourceGenerator.UnitTests.ManualMappingTests.PersonWithOptionalPhoneType1 personWithOptionalPhoneType1)
                        => new(
                            personWithOptionalPhoneType1.Name,
                            personWithOptionalPhoneType1.PhoneType?.MapNonNullable());
                }
                """
            },
        };
