...
```xml
        <PackageReference Include="MappingSourceGenerator" Version="0.1.0" OutputItemType="Analyzer" ReferenceOutputAssembly="false" />
        <PackageReference Include="MappingSourceGenerator.Markers" Version="0.1.0" />
```
